...
const produtos = [
  {
    ...
    mensagem: 'Olá! Vi no site da DS A Fonte a Camisa Seleção Canarinho e gostaria de solicitar um orçamento. Tamanho: ___'
  },
  {
    id: 'kit-brasil',
    ...
    mensagem: 'Olá! Vi no site da DS A Fonte o Kit Polo + Boné Seleção CBF e gostaria de solicitar um orçamento. Tamanho: ___'
  },
  {
    id: 'polo-ferrari',
    ...
    mensagem: 'Olá! Vi no site da DS A Fonte o Polo Ferrari F1 Santander e gostaria de solicitar um orçamento. Tamanho: ___'
  },
  {
    id: 'conjunto-nike',
    ...
    mensagem: 'Olá! Vi no site da DS A Fonte o Conjunto Nike Preto e Branco e gostaria de solicitar um orçamento. Tamanho: ___'
  },
  {
    id: 'santos-fc',
    ...
    mensagem: 'Olá! Vi no site da DS A Fonte a Manga Longa Santos FC e gostaria de solicitar um orçamento. Tamanho: ___'
  }
];

function solicitarOrcamento(produto) {
  const url = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(produto.mensagem)}`;
...
function renderCatalog(filter = 'todos') {
    ...
    .map(produto => `
      <article class="product-card" data-id="${produto.id}" data-category="${produto.categoria}">
        ...
        <div class="product-card__body">
          ...
          <button class="btn btn--whatsapp" data-id="${produto.id}" type="button">
  ...
  grid.querySelectorAll('.btn--whatsapp').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (produto) solicitarOrcamento(produto);
    });
  });
