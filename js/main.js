...
function renderProductGrid(grid, filter = 'todos') {
  if (!grid) return;
...
function renderCatalog(filter = 'todos') {
  renderProductGrid(document.getElementById('catalogGrid'), filter);
}

function renderHomeCatalog() {
  renderProductGrid(document.getElementById('homeCatalogGrid'), 'selecao');
}
